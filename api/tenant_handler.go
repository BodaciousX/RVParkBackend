...
func (s *Server) handleListTenants() http.HandlerFunc {
...
func (s *Server) handleUpdateTenant() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := strings.TrimPrefix(r.URL.Path, "/tenants/")
...
func (s *Server) handleDeleteTenant() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := strings.TrimPrefix(r.URL.Path, "/tenants/")
...
func (s *Server) handleGetTenantPayments() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func (s *Server) handleRecordPayment() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		path := strings.TrimPrefix(r.URL.Path, "/tenants/")
		tenantID := strings.TrimSuffix(path, "/payments")
